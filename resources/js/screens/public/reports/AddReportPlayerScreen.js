...
import { createReportPlayer } from '../../../actions/reportPlayerActions'
import { REPORTPLAYER_CREATE_RESET } from '../../../constants/reportPlayerConstants'
...
const AddReportPlayerScreen = ({ history }) => {
    ...
    const reportPlayerCreate = useSelector(state => state.reportPlayerCreate)
    const { loading, success, error } = reportPlayerCreate
    ...
    useEffect(() => {
        ...
        if (success) {
            dispatch({ type: REPORTPLAYER_CREATE_RESET })
    ...
    const submitHandler = e => {
        ...
        formData.append('user_reported', userReported)
        ...
        dispatch(createReportPlayer(formData))

        Swal.fire({
            position: 'center',
            icon: 'success',
            title: `Player "${userReported}" reported successfully`,
        ...
        <Container>
            ...
            <Paper elevation={3} className={classes.report}>
                ...
                <div className='report__header'>
                    <h3 className='report__header--title'>Report Player</h3>
                </div>
                            ...
                            <div className='form'>
                                ...
                                <div className='form__field'>
                                    <TextField
                                        ...
                                        fullWidth
                                        onChange={e =>
                                            setUserReported(e.target.value)
                                        }
                                        required
                                    />
                                </div>
...
export default AddReportPlayerScreen
