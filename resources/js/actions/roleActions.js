...
export const listRoles = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await Axios.get(`/api/auth/roles`, config);
...
export const getEditRoleDetails = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await Axios.get(`/api/auth/roles/${id}`, config);
...
export const editRole = (id, name, is_admin, perms) => async (dispatch, getState) => {
    try {
...
export const createRole = (name) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await Axios.post("/api/auth/roles", { name }, config);
...
export const deleteRole = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await Axios.delete(`/api/auth/roles/${id}`, config);
