...
export const listPermissions = () => async (dispatch, getState) => {
    try {
        ...
        const { data } = await Axios.get(`/api/auth/permissions`, config);
...
export const getEditPermissionDetails = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await Axios.get(`/api/auth/permissions/${id}`, config);
...
export const createPermission = (name) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await Axios.post("/api/auth/permissions", { name }, config);
...
export const deletePermission = (id) => async (dispatch, getState) => {
    try {
        ...
        const { data } = await Axios.delete(`/api/auth/permissions/${id}`, config);
